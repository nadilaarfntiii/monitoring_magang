...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Arsip Pengguna</h5>
    </div>
    <div class="card-body">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white fw-bold">
        <h5 class="modal-title text-white fw-bold">Konfirmasi Restore Pengguna</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <p>Apakah Anda yakin ingin merestore pengguna <strong id="restoreNama"></strong>?</p>
...
$(document).ready(function(){
    ...
    // Tombol restore diklik
    $(document).on("click", ".btn-restore", function(){
        var id = $(this).data("id");
        var nama = $(this).data("nama");

        $("#restoreId").val(id);
        $("#restoreNama").text(nama);
    ...
    $("#btnKonfirmasiRestore").on("click", function(){
        ...
        $.ajax({
            url: "<?= base_url('kelola_user/restoreAjax') ?>",
            type: "POST",
            dataType: "json",
            data: {id_user: id},
