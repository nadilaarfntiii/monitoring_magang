                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end me-4">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Arsip Mahasiswa</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="card">
    <div class="card-header">
        <h5 class="fw-bold mb-0">Arsip Mahasiswa</h5>
    </div>
            ...
            <table class="table align-middle text-center" id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-<?=
                                $m['status'] == 'selesai' ? 'primary' :
                                ($m['status'] == 'tidak selesai' ? 'warning' : 'secondary')
                            ?>">
                                <?= ucfirst($m['status']) ?>
                            </span>
                        </td>
