...
<?= $this->section('title') ?>
Data Bimbingan Analisis Sistem
<?= $this->endSection() ?>
...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    <h5 class="card-title mb-0 fw-bold">Data Bimbingan Analisis Sistem</h5>
          ...
          <?php if (!empty($mahasiswa)): ?>
            <?php $no = 1; foreach ($mahasiswa as $mhs): ?>
              <tr>
                ...
                <a href="<?= base_url('dospem/bimbingan/detail/' . $mhs['id_profil'] . '/KK166') ?>"
...
<div class="modal fade" id="modalTambahBimbingan" tabindex="-1" aria-labelledby="modalTambahBimbinganLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
        <form action="<?= base_url('dospem/bimbingan_asb/simpan') ?>" method="post">
