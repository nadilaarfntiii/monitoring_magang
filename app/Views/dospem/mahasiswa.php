                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul class="dropdown-menu">
                                      <li><a class="dropdown-item" href="<?= base_url('dospem/detailPresensi/' . $m['nim']) ?>">Presensi</a></li>
                                      <li><a class="dropdown-item" href="<?= base_url('dospem/detail_learning_plan/' . $m['nim']) ?>">Learning Plan</a></li>
                                      <li><a class="dropdown-item" href="<?= base_url('dospem/logbook/' . $m['nim']) ?>">Logbook</a></li>
                                      <li><a class="dropdown-item" href="<?= base_url('dospem/input_nilai_magang/' . $m['nim']) ?>">Penilaian</a></li>
                                    </ul>
                                    </div>
                                  </td>
...
<!-- Load script DataTables hanya jika tabel tidak kosong -->
  ...
  if (!$.fn.DataTable.isDataTable('#table1')) {
    $('#table1').DataTable({
       drawCallback: function() {
        // Aktifkan dropdown Bootstrap setelah render tabel
...
$(document).ready(function() {
  ...
  $(document).on('click', '.btn-detail', function() {
    ...
    fetch(`<?= base_url('dospem/data_mahasiswa') ?>/${id}`)
      .then(res => res.json())
      .then(res => {
