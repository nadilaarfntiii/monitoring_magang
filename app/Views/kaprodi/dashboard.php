...
<head>
    ...
    <title>Dashboard Kepala Program Studi</title>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?= (uri_string() == 'kaprodi/dashboard') ? 'active' : '' ?>">
                            <a href="<?= base_url('kaprodi/dashboard') ?>" class="sidebar-link">
                                <i class="bi bi-grid-fill"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?= (uri_string() == 'data_mahasiswa') ? 'active' : '' ?>">
                            <a href="<?= base_url('data_mahasiswa') ?>" class="sidebar-link">
                                <i class="bi bi-people-fill"></i>
                                <span>Data Mahasiswa</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?= (uri_string() == 'kelola_learning_plan') ? 'active' : '' ?>">
                            <a href="<?= base_url('kelola_learning_plan') ?>" class="sidebar-link">
                                <i class="bi bi-journal-check"></i>
                                <span>Kelola Learning Plan</span>
                            </a>
                        </li>

                        <li class="sidebar-item has-sub <?= (uri_string() == 'kaprodi/komponen_penilaian' || uri_string() == 'kaprodi/nilai_mahasiswa') ? 'active' : '' ?>">
                            <a href="#" class="sidebar-link">
                                <i class="bi bi-clipboard-data"></i>
                                <span>Nilai Magang</span>
                            </a>
                            <ul class="submenu">
                                <li class="submenu-item <?= (uri_string() == 'kaprodi/komponen_penilaian') ? 'active' : '' ?>">
                                    <a href="<?= base_url('kaprodi/komponen_penilaian') ?>">Komponen Nilai</a>
                                </li>
                                <li class="submenu-item <?= (uri_string() == 'kaprodi/nilai_mahasiswa') ? 'active' : '' ?>">
                                    <a href="<?= base_url('kaprodi/nilai_mahasiswa') ?>">Nilai Mahasiswa</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <div class="dropdown ms-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="min-width: 11rem;">
                                    ...
                                    <li><a class="dropdown-item" href="<?= base_url('kaprodi/profil'); ?>"><i class="bi bi-person me-2"></i> Profil Saya</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <h6 class="text-muted font-semibold mb-1">LP Pending</h6>
                                ...
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <h6 class="text-muted font-semibold mb-1">Selesai Magang</h6>
