                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end me-4">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url('kaprodi/kelola_learning_plan') ?>">Kelola Learning Plan</a></li>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="form-step">
                    ...
                    <div class="text-end">
                        ...
                        <?php if ($learningPlan['status_approval_kaprodi'] == 'Menunggu'): ?>
                            <!-- ✅ Tombol Setujui dengan form POST -->
                                <form action="<?= base_url('kaprodi/kelola_learning_plan/setuju/' . $learningPlan['id_lp']) ?>" method="post" class="d-inline">
                                    <?= csrf_field() ?>
                ...
                <div class="modal-dialog">
                    <form action="<?= base_url('kaprodi/kelola_learning_plan/tolak/' . $learningPlan['id_lp']) ?>" method="post">
                    <div class="modal-content">
                        ...
                        <div class="mb-3">
                            <label for="catatan" class="form-label">Catatan Kepala Program Studi</label>
                            <textarea name="catatan_kaprodi" id="catatan" class="form-control" rows="3" required></textarea>
                        </div>
                        </div>
