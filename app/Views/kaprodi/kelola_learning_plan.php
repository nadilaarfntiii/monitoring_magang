...
<?= $this->section('title') ?>
Kelola Learning Plan Mahasiswa
<?= $this->endSection() ?>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end me-4">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Kelola Learning Plan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    <h5 class="card-title mb-0 fw-bold">Learning Plan Mahasiswa</h5>
  </div>
    ...
    <div class="table-responsive">
      <table class="table align-middle text-center" id="table1">
        ...
        <tbody>
          <?php if (!empty($learningPlans)): ?>
            <?php $no = 1; foreach ($learningPlans as $lp): ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('kaprodi/kelola_learning_plan/detail/' . $lp['id_lp']) ?>" class="btn btn-sm btn-info">
          ...
          <?php else: ?>
            <tr>
              <td colspan="8" class="text-muted text-center">Belum ada Learning Plan mahasiswa di unit Anda.</td>
            </tr>
          <?php endif; ?>
        </tbody>
      </table>
