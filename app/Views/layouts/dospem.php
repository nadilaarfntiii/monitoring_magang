...
<body>
    ...
    <div id="app">
        ...
        <!-- Sidebar -->
        <div id="sidebar">
            <?= $this->include('layouts/components/sidebar_dospem') ?>
        </div>
        <!-- End Sidebar -->
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <div class="dropdown ms-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="min-width: 11rem;">
                                    ...
                                    <li><a class="dropdown-item" href="<?= base_url('dospem/profil'); ?>"><i class="bi bi-person me-2"></i> Profil Saya</a></li>
    ...
    <?php 
    $uri = service('uri');
    $segment1 = $uri->getSegment(1); // dospem
    $segment2 = $uri->getSegment(2); // data_mahasiswa
    ?>

    <?php if (!($segment1 === 'dospem' && $segment2 === 'data_mahasiswa')): ?>
