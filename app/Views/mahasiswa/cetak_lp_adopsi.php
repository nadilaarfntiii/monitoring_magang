...
<h2>LEARNING PLAN / RENCANA KEGIATAN IWIMA MENGAJAR SKEMA ADOPSI TEKNOLOGI</h2>
...
<table>
    <tr>
        <td style="width: 25%; text-align: right; font-weight: bold;">Nama Sekolah/Instansi:</td>
...
<!--     INFORMASI MAGANG    -->
<!-- ======================= -->
<div class="section-title">Informasi IWIMA Mengajar</div>
<table>
    <tr>
...
<table>
    <tr>
        <td style="width: 25%; 
            ...
            ">
            Deskripsikan Tema Adopsi Teknologi Yang Akan Dibangun
        </td>
...
<!--   CAPAIAN MAGANG        -->
<!-- ======================= -->
<div class="section-title" style="page-break-before: always;">Capaian Pembelajaran Mata Kuliah IWIMA Mengajar Skema Adopsi Teknologi</div>
...
<!--   AKTIVITAS MAGANG      -->
<!-- ======================= -->
<div class="section-title">Aktivitas Pembelajaran</div>
...
<div style="margin-top: 10px; font-size: 13px; line-height: 1.4; text-align: justify;">
    *** Kompetensi teknis yang diperoleh selama kegiatan magang dan yang relevan dengan kompetensi lulusan Program Studi yang dinyatakan dalam dokumen kurikulum. Objek Magang (Sekolah) <b>HARUS MENYEDIAKAN</b> kompetensi teknis tersebut.<br>
    *** Berikan tanda centang (√) untuk satu atau lebih kompetensi teknis yang diperoleh selama kegiatan magang.
</div>

<!-- ======================= -->
<!--  CAPAIAN Adopsi Teknologi   -->
<!-- ======================= -->
...
<div class="section-title">Aktifitas Pembelajaran Komunikasi Bisnis, Analisis, Desain Sistem, Pembanguan Sistem dI Sekolah</div>
