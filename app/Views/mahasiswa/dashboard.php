...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/iconly@2.2.1/icons.min.css">
    ...
    <div id="app">
        ...
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="logo">
                    <a href="/mahasiswa/dashboard"><img src="./assets/images/iwima.png" alt="Logo" srcset=""></a>
                </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?= (uri_string() == 'mahasiswa/dashboard') ? 'active' : '' ?>">
                            <a href="<?= base_url('mahasiswa/dashboard') ?>" class="sidebar-link">
                        ...
                        <!-- Profil Magang -->
                        <li class="sidebar-item <?= (uri_string() == 'profil_magang') ? 'active' : '' ?>">
                            <a href="<?= base_url('profil_magang') ?>" class="sidebar-link">
                                <i class="bi bi-person-badge"></i>
                                <span>Profil Magang</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?= (uri_string() == 'presensi') ? 'active' : '' ?>">
                            <a href="<?= base_url('presensi') ?>" class="sidebar-link">
                                <i class="bi bi-check-circle"></i>
                                <span>Presensi</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?= (uri_string() == 'mahasiswa/learning_plan') ? 'active' : '' ?>">
                            <a href="<?= base_url('mahasiswa/learning_plan') ?>" class="sidebar-link">
                                <i class="bi bi-journal-bookmark"></i>
                                <span>Learning Plan</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?= (uri_string() == 'logbook') ? 'active' : '' ?>">
                        ...
                        <!-- <li class="sidebar-item <?= (uri_string() == 'tugas_akhir_magang') ? 'active' : '' ?>">
                            <a href="<?= base_url('tugas_akhir_magang') ?>" class="sidebar-link">
                        ...
                        <?= (uri_string() == 'mahasiswa/bimbingan_magang' || uri_string() == 'mahasiswa/bimbingan_asb' || uri_string() == 'mahasiswa/bimbingan_dsib' || uri_string() == 'mahasiswa/bimbingan_kombis') ? 'submenu-open' : '' ?>">
                            <a href="javascript:void(0)" class="sidebar-link sidebar-toggle">
                                <i class="bi bi-person-lines-fill"></i>
                                <span>Bimbingan</span>
                            </a>
                            <ul class="submenu">
                                <li class="submenu-item <?= (uri_string() == 'mahasiswa/bimbingan_magang') ? 'active' : '' ?>">
                                    <a href="<?= base_url('mahasiswa/bimbingan_magang') ?>" class="submenu-link">Magang</a>
                                </li>
                                <!-- <li class="submenu-item <?= (uri_string() == 'mahasiswa/bimbingan_asb') ? 'active' : '' ?>">
                                    <a href="<?= base_url('mahasiswa/bimbingan_asb') ?>" class="submenu-link">Analisis Sistem Informasi Bisnis</a>
                                </li>
                                <li class="submenu-item <?= (uri_string() == 'mahasiswa/bimbingan_dsib') ? 'active' : '' ?>">
                                    <a href="<?= base_url('mahasiswa/bimbingan_dsib') ?>" class="submenu-link">Desain Sistem Informasi Bisnis</a>
                                </li>
                                <li class="submenu-item <?= (uri_string() == 'mahasiswa/bimbingan_kombis') ? 'active' : '' ?>">
                                    <a href="<?= base_url('mahasiswa/bimbingan_kombis') ?>" class="submenu-link">Komunikasi Bisnis</a>
                                </li> -->
                            </ul>
                        </li>
                    </ul>
                                    ...
                                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="user-menu d-flex align-items-center">
                                            ...
                                            <div class="avatar avatar-md">
                                                <img src="<?= !empty(session()->get('foto')) 
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end me-4">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item" active><a href="<?= base_url('mahasiswa/dashboard') ?>">Dashboard</a></li>
                                    ...
                                    <a href="#" class="text-decoration-none text-dark">
                                        <div class="card-body px-4 py-4-5">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <h6 class="text-muted font-semibold mb-1">Learning Plan</h6>
                                                    <small class="text-primary">Klik icon untuk cetak</small>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a href="#" class="text-decoration-none text-dark">
                                        <div class="card-body px-4 py-4-5">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-8">
                                                    <h6 class="text-muted font-semibold mb-1">Logbook</h6>
                                                    <small class="text-success">Klik icon untuk cetak</small>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="card">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-8">
                                                <h6 class="text-muted font-semibold mb-1">Bimbingan</h6>
                                                <span class="badge bg-info">BAB II</span>
                                                <!-- contoh lain: BAB I / BAB III -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
