        ...
        <div class="container mt-4">
            <div class="card shadow-sm border-0">
                ...
                <div class="form-step active">
                    ...
                    <form id="learningPlanForm" action="<?= base_url('mahasiswa/learningplan/store') ?>" method="post">
            ...
            <div class="form-step">
                ...
                <p class="text-muted mb-3" style="font-size: 0.9rem;">
                    Tuliskan <strong>deskripsi posisi pekerjaan</strong> yang Anda jalani selama magang, 
                    serta <strong>uraian pekerjaan</strong> yang Anda lakukan sehari-hari.
                </p>
          ...
          <!-- STEP 5: CAPAIAN PEMBELAJARAN MAGANG -->
            <div class="form-step">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            <?php 
                            // Ambil daftar urutan aktivitas yang sudah dicentang dari $aktivitas
            ...
            <div class="form-step">
                <h6 class="fw-bold border-bottom pb-2 mb-3">
                    Capaian Pembelajaran Mata Kuliah Komunikasi Bisnis, Analisis Sistem dan Desain Sistem di Perusahaan/Instansi
                </h6>
                ...
                <h6 class="fw-bold mt-3">Aktivitas Pembelajaran Mata Kuliah Komunikasi Bisnis, Analisis Sistem dan Desain Sistem di Perusahaan/Instansi</h6>
                <div class="table-responsive">
                    <table class="table table-bordered align-middle">
                        <thead class="table-light text-center">
                            <tr>
