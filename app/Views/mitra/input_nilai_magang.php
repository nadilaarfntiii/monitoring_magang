                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end me-4">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url('mitra/kelola_penilaian') ?>">Kelola Nilai Mahasiswa</a></li>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <!-- FORM INPUT NILAI -->
        <form action="<?= base_url('simpan_nilai_magang/' . $mahasiswa['nim']) ?>" method="post">
